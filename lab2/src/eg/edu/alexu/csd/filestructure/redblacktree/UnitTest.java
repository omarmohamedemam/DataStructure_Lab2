...
public class UnitTest {
	...
	private boolean verifyProps(INode<Integer, String> root) {
		boolean b2,b3,b4,b5,bst;
		b2=verifyProperty2(root);
		b3=verifyProperty3(root);
		b4=verifyProperty4(root);
		b5=verifyProperty5(root);
		bst=validateBST(root, null, null);
		return b2 && b3 &&  b4 && b5 && bst;
	}
